        ...
        for (let i = 0; i < fullStars; i++) {
            stars.push(
                <Star
                    ...
                    className=" fill-amber-600 stroke-amber-600"
                />,
            );
        }
        ...
        if (hasHalfStar) {
            stars.push(
                <div key="rating-half-star" className="relative">
                    <StarHalf className="absolute top-0 right-0 fill-amber-600 stroke-amber-600" />
                    <StarHalf className="absolute top-0 left-0 -scale-x-100 fill-amber-600/15 stroke-amber-600/15" />
                </div>,
            );
        }
